...
namespace GreenBox3D.Utilities
{
    public class ContentCrc32 : HashAlgorithm
    {
        #region Constants

        public const uint DefaultSeed = 0x7983AC93;
        ...
        public uint CrcValue { get { return (uint)((HashValue[0] << 24) | (HashValue[1] << 16) | (HashValue[2] << 8) | HashValue[3]); } }
        ...
        {
            return HashValue = new[] { (byte)((_crcValue >> 24) & 0xff), (byte)((_crcValue >> 16) & 0xff), (byte)((_crcValue >> 8) & 0xff), (byte)(_crcValue & 0xff) };
            ;
        }
